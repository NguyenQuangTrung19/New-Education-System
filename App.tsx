...
const App: React.FC = () => {
  ...
  const renderContent = () => {
    switch (currentPage) {
      ...
      case "teachers":
        return <Teachers currentUser={currentUser} />;
      case "students":
        return <Students currentUser={currentUser} />;
      case "classes":
        return <Classes currentUser={currentUser} />;
      case "subjects":
        return <Subjects currentUser={currentUser} />;
      case "timetable":
        return (
          <Timetable currentUser={currentUser} onNavigate={handleNavigate} />
        );
      case "profile":
      ...
      case "my-classes":
        return (
          <MyClasses
            currentUser={currentUser!}
            initialClassId={navParams?.classId}
          />
        );
      case "teacher-assignments":
        return <TeacherAssignments currentUser={currentUser!} />;
      case "teacher-resources":
        return <TeacherResources currentUser={currentUser!} />;
      case "student-class":
        return <StudentClass currentUser={currentUser!} />;
      case "rules":
        return <Rules />;
      case "student-results":
        return <StudentResults currentUser={currentUser!} />;
      case "leaderboard":
        return <Leaderboard currentUser={currentUser!} />;
      case "tuition":
        return <Tuition currentUser={currentUser!} />;
      case "admin-tuition":
        return <AdminTuition currentUser={currentUser!} />;
      default:
        return (
          <Dashboard
            onNavigate={handleNavigate}
  ...
  const getPageTitle = () => {
    switch (currentPage) {
      ...
      case "teachers":
        return t("menu.teachers");
      case "students":
        return t("menu.students");
      case "classes":
        return t("menu.classes");
      case "subjects":
        return t("menu.subjects");
      case "timetable":
        return t("menu.timetable");
      case "profile":
        return t("menu.profile") || "My Profile";
      case "notifications":
        return t("menu.notifications");
      case "my-classes":
        return t("menu.myClasses");
      case "teacher-assignments":
        return "Tạo & Quản lý Bài tập";
      case "teacher-resources":
        return "Kho Tài Liệu";
      case "student-class":
        return "Lớp của tôi";
      ...
      case "leaderboard":
        return t("menu.leaderboard") || "Bảng Xếp Hạng";
      case "tuition":
        return t("menu.tuition") || "Học phí & Dịch vụ";
      case "admin-tuition":
        return t("menu.adminTuition") || "Quản lý Học phí";
      default:
        return "EduSphere";
    }
  };
