        ...
        <div className="bg-white rounded-3xl shadow-2xl w-full max-w-2xl overflow-hidden animate-scale-in relative flex flex-col max-h-[90vh]">
            ...
            <div className="h-32 bg-gradient-to-r from-glacier-lake to-glacier-dark relative shrink-0">
                ...
                <div className="absolute -bottom-10 left-8 flex items-end">
                    <div className="w-20 h-20 bg-white rounded-2xl p-2 shadow-lg rotate-3">
                        <img 
  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden font-sans">
      ...
      <div className="relative z-10 w-full max-w-[460px] px-6">
        <div className="bg-white/10 backdrop-blur-xl p-8 md:p-10 rounded-[2.5rem] shadow-2xl border border-white/40 animate-fade-in-up relative overflow-hidden">
          ...
          <div className="text-center mb-10 relative z-10">
            <div className="inline-flex items-center justify-center w-28 h-28 rounded-3xl bg-ice-white shadow-xl mb-6 transform rotate-3 hover:rotate-0 transition-transform duration-500 ring-4 ring-white/30">
               <img 
                 src={SCHOOL_INFO.logo} 
                 onError={(e) => {e.currentTarget.src = SCHOOL_INFO.logoFallback}}
            ...
            <h1 className="text-3xl font-black text-white tracking-tight uppercase drop-shadow-md">{SCHOOL_INFO.name}</h1>
          ...
          <div className="bg-black/20 p-1.5 rounded-2xl mb-8 flex relative backdrop-blur-sm border border-white/10">
              {[
                  ...
                  <button 
                      ...
                      className={`flex-1 flex items-center justify-center py-3 text-xs font-bold rounded-xl transition-all duration-300 relative z-10 ${role === item.r ? 'bg-ice-white text-glacier-dark shadow-lg scale-105' : 'text-white/70 hover:text-white hover:bg-white/5'}`}
                  >
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  type="email"
                  required
                  className="block w-full pl-12 pr-4 py-4 bg-black/20 border border-white/10 rounded-xl text-white placeholder-white/40 focus:outline-none focus:bg-black/30 focus:border-white/30 transition-all font-medium"
                  value={email}
            ...
            <div className="space-y-2">
              ...
              <div className="relative group">
                ...
                <input
                  ...
                  required
                  className="block w-full pl-12 pr-12 py-4 bg-black/20 border border-white/10 rounded-xl text-white placeholder-white/40 focus:outline-none focus:bg-black/30 focus:border-white/30 transition-all font-medium"
                  value={password}
