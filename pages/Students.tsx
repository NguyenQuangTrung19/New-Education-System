...
export const Students: React.FC<StudentsProps> = ({ currentUser }) => {
  ...
  const [formStudent, setFormStudent] =
    useState<Partial<Student>>(defaultStudentState);
  ...
  const validateStudentForm = (data: Partial<Student>): string[] => {
    ...
    if (!editingStudent && !data.password?.trim())
    ...
    if (!data.guardianName?.trim())
      errors.push("Tên người giám hộ không được để trống.");
    if (!data.guardianPhone?.trim())
      errors.push("SĐT người giám hộ không được để trống.");
    if (!data.guardianCitizenId?.trim())
      errors.push("CCCD người giám hộ không được để trống.");
  ...
  const StudentDetailModal = ({
    ...
    const chartData = [
      ...history.map((r) => ({ year: r.year, gpa: r.gpa })),
      { year: "Now", gpa: student.gpa },
    ];
              ...
              <div className="relative -mt-14 mb-8 bg-white rounded-xl shadow-lg border border-gray-100 p-6 flex flex-col md:flex-row gap-6 items-center md:items-start z-10">
                ...
                <div className="flex-1 text-center md:text-left">
                  ...
                  <div className="flex flex-wrap justify-center md:justify-start gap-3 mt-2 text-sm">
                    ...
                    <span className="px-2 py-0.5 bg-yellow-100 text-yellow-700 rounded-full font-bold text-xs flex items-center">
                ...
                {canEdit && (
                  <div className="flex gap-2">
                    <button
                      ...
                      className="px-4 py-2 bg-white border border-gray-200 text-gray-700 rounded-lg hover:bg-gray-50 transition font-medium text-sm shadow-sm"
                    >
                      Edit Profile
                    </button>
                  </div>
                  ...
                  <div className="bg-white p-6 rounded-xl border border-gray-200 shadow-sm">
                    ...
                    <div className="space-y-3 text-sm">
                      ...
                      <div className="flex justify-between">
                        ...
                        <span className="font-mono text-gray-700 bg-gray-100 px-2 rounded">
                          {student.username}
                        </span>
                      </div>
                    </div>
                    ...
                    <div className="p-6">
                      <div className="space-y-2 mb-4 max-h-32 overflow-y-auto custom-scrollbar">
                        {student.notes?.map((n, i) => (
                          <div
                            key={i}
                            className="p-2.5 bg-white text-xs text-gray-600 rounded border border-gray-100 shadow-sm"
                          >
                            {n}
                          </div>
                        ))}
                      ...
                      {canEdit && (
                        <div className="flex gap-2">
                          <input
                            ...
                            onKeyDown={(e) =>
                              e.key === "Enter" &&
                              (handleAddNote(student.id, noteInput),
                              setNoteInput(""))
                            }
                          ...
                          <button
                            ...
                            className="p-2 bg-indigo-500 text-white rounded-lg hover:bg-indigo-600 shadow-sm shrink-0 flex items-center justify-center"
                          >
              ...
              <div className="px-6 py-6 bg-indigo-600 text-white shrink-0 shadow-md flex justify-between items-start">
                <div>
                  ...
                  <p className="text-indigo-100 text-sm mt-1">
                    Complete the academic & personal profile
                  </p>
                </div>
                <button
                  onClick={() => setIsFormOpen(false)}
                  ...
                  <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <input
                          type="number"
                          className="w-full px-3 py-2 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 text-sm outline-none"
                          value={formStudent.enrollmentYear}
                          onChange={(e) =>
                            setFormStudent({
                              ...formStudent,
                              enrollmentYear: parseInt(e.target.value) || 2024,
                            })
                          }
                        />
                      </div>
                      <div className="col-span-2">
                        ...
                        <div className="relative">
                          <select
                            className="w-full px-3 py-2 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 text-sm outline-none appearance-none"
                  ...
                  <div className="bg-white p-5 rounded-xl border border-gray-200 shadow-sm space-y-4">
                    ...
                    <div className="space-y-3">
                      ...
                      <div>
                        ...
                        <input
                          type="password"
                          placeholder={editingStudent ? "Unchanged" : "••••••"}
                          className="w-full px-3 py-2 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 text-sm outline-none"
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        ...
                        <div>
                          ...
                          <input
                            type="number"
                            className="w-full px-3 py-2 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 text-sm outline-none"
                            value={formStudent.guardianYearOfBirth}
                            onChange={(e) =>
                              setFormStudent({
                                ...formStudent,
                                guardianYearOfBirth: parseInt(e.target.value),
                              })
                            }
                          />
                        </div>
                        ...
                        <div>
                          ...
                          <input
                            ...
                            required
                            className="w-full px-3 py-2 bg-white border border-gray-300 rounded-lg focus:ring-2 focus:ring-indigo-500 text-sm outline-none"
                            value={formStudent.guardianCitizenId}
                            onChange={(e) =>
                              setFormStudent({
                                ...formStudent,
                                guardianCitizenId: e.target.value,
                              })
                            }
                          />
                        </div>
        ...
        <div className="p-5 border-b border-gray-100 flex flex-col md:flex-row gap-4 items-center justify-between bg-white">
          ...
          <div className="flex items-center gap-2 w-full md:w-auto">
            <div className="relative">
              ...
              <select
                className="pl-10 pr-8 py-2.5 bg-gray-50 border border-gray-200 rounded-xl text-sm focus:ring-2 focus:ring-indigo-500 focus:bg-white outline-none appearance-none cursor-pointer"
                value={selectedClass}
          ...
          {filteredStudents.length === 0 && (
            <div className="p-12 text-center">
              ...
              <p className="text-gray-500 mt-1">
                Try changing class filters or search query.
              </p>
            </div>
          )}
        </div>
          ...
          <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-900/60 backdrop-blur-md w-screen h-screen">
            <div className="bg-white rounded-xl shadow-xl w-full max-w-sm p-6 animate-scale-in">
              ...
              <p className="text-sm text-gray-500 mb-4">
                ...
                <strong>{studentToReveal?.name}</strong>.
              </p>
